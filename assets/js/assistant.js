...
(function () {
  ...
  var KB = [
    ...
    { id: "contact", keys: "contact email phone number reach call telephone write speak talk human person specialist someone real",
      a: "Reach us at <strong>info@gisconsulting.in</strong> or <strong>+91 124 401 0000</strong> (Mon–Fri, 09:00–18:00 IST). For proposals, the contact form routes you to the right specialist.",
      cta: CONTACT_CTA },
    ...
    { id: "apply", keys: "apply cv resume application send submit",
      a: "Apply against a specific role, or send your CV to <strong>careers@gisconsulting.in</strong> — every application is read by a person, not a filter.",
